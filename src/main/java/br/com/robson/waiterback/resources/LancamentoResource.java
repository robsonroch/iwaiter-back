...
import br.com.robson.waiterback.dtos.AtualizaStatusDTO;
import br.com.robson.waiterback.dtos.LancamentoDTO;
...
public class LancamentoResource {
	...
	public ResponseEntity buscar(
		...
		Optional<User> usuario = userService.getById(idUsuario);
